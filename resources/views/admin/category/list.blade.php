    ...
    <div class="container-fluid">
            ...
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        ...
                        <form action="{{ route('admin.category.list') }}" method="GET" class="row gy-2 gx-3 align-items-center">
                            ...
                            @if(request()->has('search_keyword') && request('search_keyword') != '')
                                <div class="col-md-auto">
                                    <a href="{{ route('admin.category.list') }}" class="btn btn-secondary">Reset Filter</a>
                                </div>
                            @endif
                        </form>
                    </div>
        ...
        <div class="card w-100 position-relative overflow-hidden">
            <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.category.add') }}" class="btn btn-primary btn-sm me-2">Tambah Data</a>
                </div>
            </div>
